const CONSTANT = {
  ...
  JWT_EXPIRED_PERIOD: 3 * 24 * 60 * 60 * 1000, // 3 days
  EMPTY_DATE: '-----',
  
  WEBPAGE_ACCESS_CODE: 'ee5c4a60-61b0-4b55-a0e0-528bf3efcf0b',
 
  
  ERROR_MESSAGES: {
    NOT_PERMISSION: "You don't have permission for this action!",
    CANNOT_UPDATE: 'This order type can not update.',
    CANNOT_CANCEL: '* You are not able to cancel liquidate order!',
  },
  ...
  DATE_FORMAT: {
    ...
    SHORT: 'YYYY-MM-DD',
    CLIENT_SHORT_DATE: 'MM-DD-YYYY',
  },

  ENCRYPTION: {
    ALGORITHM: 'aes-256-cbc',
    ENCODING: 'base64',
    INITIALIZATION_VECTOR: 'Two8edXdg/Hia9lpkjxcKg==',
    SALT: 'nPl',
  },
