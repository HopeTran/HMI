const CONSTANTS = {
  ...
  NPL_PERMISSIONS: {
    ...
    EDIT_ROLE: 'edit-role',
    EDIT_USER_ROLE_SETTING: 'edit-user-role-setting',
    CHEF: 'chef',
  },
  ...
  DEFAULT_DIALOG_STYLE: { width: '750px' },
  STATUS_CODES: {
    BAD_REQUEST: 400,
    NOT_FOUND: 404,
    NOT_ACCEPTABLE: 406,
  ...
  ORDER_STATUS: {
    ...
    NEED_TO_DELIVERY: 'need_to_delivery',
...
export const DATE_ENGLISH_LOCALE = {
  firstDayOfWeek: 1,
...
export const SORTVALUES = [
  { label: 'Pick for you', value: 'pick-for-you' },
...
export const DELIVERYTIMERANGES = [
  { label: '9:00AM - 12noon', value: '9:00:00-12:00:00' },
  { label: '12noon - 3:00PM', value: '12:00:00-15:00:00' },
  { label: '3:00PM - 6:00PM', value: '15:00:00-18:00:00' },
  { label: '6:00PM - 9:00PM', value: '18:00:00-21:00:00' },
  { label: '9:00PM - 12:00AM', value: '21:00:00-23:59:59' },
];
...
export const REASON_CANCEL_ORDER_LIST = [
  { label: 'This meal is sold out', value: 'This meal is sold out' },
  {
    label: 'There were some Internal problems, which made it impossible to serve meals',
    value: 'There were some Internal problems, which made it impossible to serve meals',
  },
];

export const DELIVERY_TYPES = [
  { label: 'Delivery Today', value: 'Delivery Today' },
  { label: 'Schedule for later', value: 'Schedule for later' },
];

export const DISPLAYED_STORES = 4;
...
export const DELIVERY_OPTIONS = [
  {label: 'Meet at door', value: 'meet_at_door' },
  {label: 'Meet outside', value: 'meet_outside' },
